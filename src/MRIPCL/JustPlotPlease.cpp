...
JustPlotPlease::JustPlotPlease() {
	...
	this->viewer = new pcl::visualization::PCLVisualizer ("Point Cloud Viewrzz ;) Hi Chris",true);
...
void JustPlotPlease::PlusCloud(pcl::PointCloud<pcl::PointXYZ> * cloudnine, int id, unsigned char r, unsigned char g, unsigned char b) {
    ...
    viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 3, &dig);
}
